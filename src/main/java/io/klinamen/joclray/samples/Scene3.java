...
//                .add(new PointLight()
//                        .setIntensity(1f)
//                        .setPosition(new FloatVec4(12, 0, -25))
//                )
                .add(new SpotLight()
                        .setIntensity(1.2f)
                ...
                .add("Teapot", Meshes.teapot()
                        .transform(new CompositeTransformation()
                                ...
                                .add(new ScaleTransformation(0.6, 0.6, 0.6))
                                .add(new TranslateTransformation(-4, -5, -30))
                        )
                ...
                .add("Bunny", Meshes.bunnyLow()
                                ...
                                .setKd(new FloatVec4(0.449f, 0.433f, 0.445f))
                                .setKs(new FloatVec4(0.4f, 0.4f, 0.4f))
//                                .setKr(new FloatVec4(0.2f, 0.2f, 0.f))
                                .setPhongExp(10)
                )
                ;
    }

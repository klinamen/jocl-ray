...
//                                .setKr(new FloatVec4(1f, 1f, 1f))
//                                .setKt(new FloatVec4(1f, 1f, 1f))
//                                .setIor(IoR.WATER)
//                        )
//                )
                .add("Sphere_Diffuse", new Sphere()
                        .setCenter(new FloatVec4(0.2f, -2.8f, -17))
                        .setRadius(2f)
                        .setMaterial(new Glass()
                ...
                .add("Cube_Blue", Meshes.cube()
                        ...
                        .setMaterial(new Glass()
                                .setKr(new FloatVec4(1.2f, 1.2f, 1.2f))
                                .setKt(new FloatVec4(1.2f, 1.2f, 1.2f))
                                .setIor(IoR.WINDOW_GLASS)
                        )
                )
//                .add("Teapot", teapot()
...
//                        .setMaterial(new Glass()
//                                .setKt(new FloatVec4(0.8f, 0.6f, 0.7f))
//                                .setKr(new FloatVec4(0.8f, 0.6f, 0.7f))
//                                .setIor(IoR.WINDOW_GLASS)
//                        )
//                )
                ;
...
//          addSphereLight(scene, "Back", new FloatVec4(-1, -1f, -30f), 1f, new FloatVec4(100, 100, 100), 1.5f);
        return scene;
    }
    ...
    private static void addXZLightsArray(Scene scene, float xSize, float zSize, int xCount, int zCount, FloatVec4 corner) {
        ...
        FloatVec4 emission = new FloatVec4(1200, 1200, 1200).div(xCount * zCount);

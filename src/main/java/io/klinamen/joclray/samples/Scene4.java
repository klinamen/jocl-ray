...
//                .add(new PointLight()
//                        .setIntensity(2f)
//                        .setPosition(new FloatVec4(-6, 5, -5))
//                )
                .add(new PointLight()
                        .setIntensity(1f)
...
//                )
                .add("Teapot_Glass_Blue", teapot()
                        .transform(new TranslateTransformation(10, -3, -15))
                        .setIor(IoR.WATER)
                        .setKd(new FloatVec4(0.0f, 0f, 0.05f))
                )
                .add("Sphere_Red", new Sphere()
                        .setCenter(new FloatVec4(3, -4, -10))
                        .setRadius(1)
                ...
                .add("Teapot_Red", teapot()
                        .transform(new TranslateTransformation(5, -3, -20))
                        .setIor(0)
                        .setKd(new FloatVec4(0.5f, 0f, 0f))
                )
                .add("Sphere_Glass", new Sphere()
                        .setCenter(new FloatVec4(-2, -4, -15))
                        .setRadius(1)
                        .setIor(IoR.WATER)
//                        .setKd(new FloatVec4(0.05f, 0.f, 0.f))
                ...
                .add("Teapot_Glass_Green", teapot()
                        .transform(new TranslateTransformation(0, -3, -25))
                        .setIor(IoR.WATER)
                        .setKd(new FloatVec4(0f, 0.05f, 0f))
                )
                .add("Sphere_Red", new Sphere()
                        .setCenter(new FloatVec4(-7, -4, -20))
                        .setRadius(1)
                        .setKd(new FloatVec4(0.5f, 0.1f, 0.0f))
                        .setKs(new FloatVec4(0.5f, 0.5f, 0.5f))
                        .setKr(new FloatVec4(0.2f, 0.2f, 0.2f))
                ...
                .add("Teapot_Tan", teapot()
                        .transform(new TranslateTransformation(-5, -3, -30))
                        .setIor(0)
                        .setKd(new FloatVec4(0.2f, 0.2f, 0.15f))
                )
                .add("Sphere_Glass", new Sphere()
                                .setCenter(new FloatVec4(-12, -4, -25))
                                .setRadius(1)
                                .setIor(IoR.WATER)
//                        .setKd(new FloatVec4(0.5f, 0.1f, 0.0f))
                                .setKs(new FloatVec4(0.5f, 0.5f, 0.5f))

...
public class HierarchicalFaceSetIntersectionKernel extends AbstractIntersectionKernel<TriangleMesh> {
    ...
    public HierarchicalFaceSetIntersectionKernel(cl_context context, OctreeBuilder octreeBuilder) {
        super(context);
